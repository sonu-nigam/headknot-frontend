...
export const languages: LanguageOption[] = [
    { name: "arabic", label: "Arabic", value: "ar" as LanguageOption["value"] },
    {
        name: "chinese",
        label: "Chinese",
        value: "zh" as LanguageOption["value"],
    },
    {
        name: "english",
        label: "English",
        value: "en" as LanguageOption["value"],
    },
    ...
    { name: "greek", label: "Greek", value: "gr" as LanguageOption["value"] },
    {
        name: "italian",
        label: "Italian",
        value: "it" as LanguageOption["value"],
    },
    {
        name: "japanese",
        label: "Japanese",
    ...
    { name: "korean", label: "Korean", value: "ko" as LanguageOption["value"] },
    {
        name: "russian",
        label: "Russian",
        value: "ru" as LanguageOption["value"],
    },
    {
        name: "spanish",
        label: "Spanish",
        value: "es" as LanguageOption["value"],
    },
    {
        name: "swedish",
        label: "Swedish",
        value: "sv" as LanguageOption["value"],
    },
    {
        name: "ukrainian",
        label: "Ukrainian",
